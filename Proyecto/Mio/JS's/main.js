        ...
        if (UnoNumeroCliente == "") {
            ...
            if (UnoEdad == "") {
                ...
                if (UnoNumero == "") {
                    ...
                    document.getElementById("UnoNom").value = "";
                    document.getElementById("UnoNdC").value = "";
                    document.getElementById("UnoEda").value = "";
                    document.getElementById("UnoNum").value = "";
                }
            }
        }
...
function agregarPrestamos() {
    ...
    var DosMonto = parseInt(document.getElementById("DosMon").value);
    var DosPlazo = document.getElementById("DosPla").value;
    var DosPagos = document.getElementById("DosPag").value;

    var ope = DosMonto * 15 /100;
    var resul = (DosMonto) + (ope);
    ...
    if (DosMonto == "") {
        ...
        document.getElementById("2-8").innerHTML += "$" + resul + "<br>";

        document.getElementById("DosMon").value = "";
    }
}
...
function agregarPago() {
    ...
    if (TresMonto == "") {
        ...
        document.getElementById("TresMon").value = "";
    }
    ...
    //document.getElementById('2-8').innerHTML = contador + "<br>";
}
